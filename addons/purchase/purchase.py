        ...
        for procurement in self.browse(cr, uid, ids, context=context):
            ...
            if not partner:
                ...
                if available_draft_po_ids:
                    ...
                    if context.get('ou_uid', False):
                        po_vals.update({'operating_unit_id': procurement.rule_id.picking_type_id.warehouse_id.operating_unit_id.id})
...
class product_product(osv.Model):
    ...
    def _purchase_count(self, cr, uid, ids, field_name, arg, context=None):
        ...
        return {
            product_id: Purchase.search_count(cr,SUPERUSER_ID, [('order_line.product_id', '=', product_id)], context=context)
